  ...
  assessment: {
    ...
    questions: [
      ...
      },
      {
        id: '1.4-q2',
        type: 'multiple-choice',
        text: '¿Cuál de las siguientes es una técnica de minería de datos?',
        options: [
          { id: 'a', text: 'Clustering para descubrir grupos automáticamente' },
          { id: 'b', text: 'Imprimir reportes en PDF' },
          { id: 'c', text: 'Hacer respaldo de una base de datos' },
          { id: 'd', text: 'Diseñar una interfaz de usuario' },
        ],
        correctAnswer: 'a',
        explanation: 'El clustering es una técnica de minería de datos que descubre patrones y agrupaciones automáticamente en grandes volúmenes de datos.',
        conceptLinked: 'Minería de datos',
        difficulty: 'easy',
      },
      {
        id: '1.4-q3',
        type: 'multiple-choice',
        text: 'Un modelo que agrupa clientes según su comportamiento de compra, sin predecir nada futuro, es un modelo:',
        options: [
          { id: 'a', text: 'Predictivo' },
          { id: 'b', text: 'Descriptivo' },
          { id: 'c', text: 'De regresión' },
          { id: 'd', text: 'Supervisado' },
        ],
        correctAnswer: 'b',
        explanation: 'Los modelos descriptivos explican qué está pasando en los datos (como el clustering o la segmentación) sin intentar predecir el futuro.',
        conceptLinked: 'Modelado',
        difficulty: 'medium',
      },
    ],
  },
