  ...
  assessment: {
    ...
    questions: [
      ...
      },
      {
        id: '3.4-q2',
        type: 'multiple-choice',
        text: '¿Qué tipo de gráfica es más adecuada para detectar outliers y comparar la dispersión entre grupos?',
        options: [
          { id: 'a', text: 'Gráfica circular' },
          { id: 'b', text: 'Boxplot' },
          { id: 'c', text: 'Gráfica de líneas' },
          { id: 'd', text: 'Heatmap' },
        ],
        correctAnswer: 'b',
        explanation: 'El boxplot resume cinco números (mínimo, cuartiles, máximo) y muestra outliers, ideal para comparar dispersión entre grupos.',
        conceptLinked: 'Tipos de gráfica',
        difficulty: 'easy',
      },
      {
        id: '3.4-q3',
        type: 'interpretation',
        text: 'Según los principios de visualización efectiva de la lección, ¿cuál de las siguientes es una mala práctica?',
        options: [
          { id: 'a', text: 'Usar ejes que empiezan en cero' },
          { id: 'b', text: 'Truncar los ejes para exagerar diferencias' },
          { id: 'c', text: 'Usar títulos y etiquetas claras' },
          { id: 'd', text: 'Elegir el tipo de gráfica según el mensaje' },
        ],
        correctAnswer: 'b',
        explanation: 'Truncar los ejes para exagerar diferencias engaña visualmente al lector; es una de las malas prácticas señaladas en la lección.',
        conceptLinked: 'Malas prácticas',
        difficulty: 'medium',
      },
    ],
  },
