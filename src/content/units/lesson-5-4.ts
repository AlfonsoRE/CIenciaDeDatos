  ...
  assessment: {
    ...
    questions: [
      ...
      },
      {
        id: '5.4-q2',
        type: 'multiple-choice',
        text: '¿Cuál de las siguientes herramientas se usa para análisis rápido de datos con mejor rendimiento que pandas en datasets grandes?',
        options: [
          { id: 'a', text: 'DuckDB / Polars' },
          { id: 'b', text: 'PowerPoint' },
          { id: 'c', text: 'Notepad' },
          { id: 'd', text: 'Photoshop' },
        ],
        correctAnswer: 'a',
        explanation: 'DuckDB y Polars son herramientas emergentes diseñadas para análisis rápido de datos a gran escala.',
        conceptLinked: 'Herramientas emergentes',
        difficulty: 'easy',
      },
      {
        id: '5.4-q3',
        type: 'interpretation',
        text: 'Según los principios de comunicación de resultados de la lección, ¿cuál es la mejor práctica?',
        options: [
          { id: 'a', text: 'Mostrar todo el código antes de las conclusiones' },
          { id: 'b', text: 'Conocer a la audiencia y empezar con el hallazgo clave' },
          { id: 'c', text: 'Usar la mayor cantidad de gráficas posible' },
          { id: 'd', text: 'Evitar documentar el código' },
        ],
        correctAnswer: 'b',
        explanation: 'La lección recomienda conocer a la audiencia y empezar con el hallazgo clave para comunicar resultados de forma efectiva.',
        conceptLinked: 'Comunicación de resultados',
        difficulty: 'medium',
      },
    ],
  },
