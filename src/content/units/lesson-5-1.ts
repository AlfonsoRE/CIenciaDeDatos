  ...
  assessment: {
    ...
    questions: [
      ...
      },
      {
        id: '5.1-q2',
        type: 'multiple-choice',
        text: 'Un modelo de reconocimiento facial fue entrenado mayormente con rostros de un solo grupo demográfico, y por eso falla más con los demás grupos. ¿Qué tipo de sesgo es?',
        options: [
          { id: 'a', text: 'Sesgo de muestreo' },
          { id: 'b', text: 'Sesgo de evaluación' },
          { id: 'c', text: 'Sesgo de despliegue' },
          { id: 'd', text: 'Sesgo de hiperparámetros' },
        ],
        correctAnswer: 'a',
        explanation: 'La subrepresentación de ciertos grupos en los datos de entrenamiento es un sesgo de muestreo.',
        conceptLinked: 'Tipos de sesgo',
        difficulty: 'medium',
      },
      {
        id: '5.1-q3',
        type: 'interpretation',
        text: 'Según la lección, ¿por qué es imposible lograr "equidad perfecta" en un modelo?',
        options: [
          { id: 'a', text: 'Porque los modelos de ML nunca son precisos' },
          { id: 'b', text: 'Porque no se pueden satisfacer todas las definiciones de equidad simultáneamente' },
          { id: 'c', text: 'Porque la ley lo prohíbe en todos los países' },
          { id: 'd', text: 'Porque los datos siempre son gratuitos' },
        ],
        correctAnswer: 'b',
        explanation: 'Distintas métricas de equidad (paridad demográfica, igualdad de oportunidades, calibración) pueden entrar en conflicto entre sí; se debe elegir la más relevante según el contexto.',
        conceptLinked: 'Métricas de equidad',
        difficulty: 'hard',
      },
    ],
  },
