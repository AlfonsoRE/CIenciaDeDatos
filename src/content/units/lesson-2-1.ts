  ...
  assessment: {
    ...
    questions: [
      ...
      },
      {
        id: '2.1-q3',
        type: 'multiple-choice',
        text: '¿Cuál de las siguientes preguntas es de tipo inferencial?',
        options: [
          { id: 'a', text: '¿Cuántos clientes tenemos hoy?' },
          { id: 'b', text: '¿La campaña de marketing tuvo un efecto real o fue azar?' },
          { id: 'c', text: '¿Cuál es el rango de edades de nuestros usuarios?' },
          { id: 'd', text: '¿Cuál es el producto más vendido del mes?' },
        ],
        correctAnswer: 'b',
        explanation: 'Determinar si un efecto observado es real o producto del azar requiere generalizar con una prueba de hipótesis, lo cual es inferencial.',
        conceptLinked: 'Formulación de preguntas',
        difficulty: 'medium',
      },
    ],
  },
