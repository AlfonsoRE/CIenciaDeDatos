  ...
  assessment: {
    ...
    questions: [
      ...
      },
      {
        id: '1.2-q3',
        type: 'interpretation',
        text: 'Según la lección, ¿cuál de las siguientes afirmaciones es correcta?',
        options: [
          { id: 'a', text: 'La Ciencia de Datos siempre requiere Machine Learning' },
          { id: 'b', text: 'Un análisis estadístico simple puede ser más efectivo que un modelo complejo' },
          { id: 'c', text: 'IA y ML son términos sinónimos' },
          { id: 'd', text: 'El Deep Learning es más amplio que la IA' },
        ],
        correctAnswer: 'b',
        explanation: 'La lección advierte que la CD no siempre requiere ML: un análisis estadístico simple puede ser más efectivo que un modelo complejo innecesario.',
        conceptLinked: 'Relación CD/ML/IA',
        difficulty: 'medium',
      },
    ],
