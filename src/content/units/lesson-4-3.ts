  ...
  assessment: {
    ...
    questions: [
      ...
      },
      {
        id: '4.3-q3',
        type: 'multiple-choice',
        text: '¿Cuál es una técnica común para reducir el sobreajuste en un solo árbol de decisión?',
        options: [
          { id: 'a', text: 'Aumentar la profundidad máxima sin límite' },
          { id: 'b', text: 'Limitar la profundidad (max_depth) o el mínimo de muestras por hoja' },
          { id: 'c', text: 'Eliminar el conjunto de prueba' },
          { id: 'd', text: 'Usar una sola variable predictora' },
        ],
        correctAnswer: 'b',
        explanation: 'Podar el árbol limitando max_depth o min_samples_leaf evita que memorice el training data.',
        conceptLinked: 'Sobreajuste en árboles',
        difficulty: 'easy',
      },
    ],
  },
