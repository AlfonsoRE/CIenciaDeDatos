  ...
  visualExamples: [
    {
      ...
      items: [
        ...
        { label: 'No supervisado', detail: 'Sin etiquetas: clustering (K-Means) o reducción (PCA).', color: 'warning' },
        { label: 'Semisupervisado', detail: 'Pocas etiquetas + muchos sin etiquetar.', color: 'success' },
        { label: 'Por refuerzo', detail: 'Aprende por recompensa/castigo: robótica, juegos, IA.', color: 'danger' },
      ],
    },
  ],
  activities: [
    {
      ...
      title: 'Clasificar problema',
      question: 'Agrupar clientes por patrones de compra es un problema de:',
      options: [
        { id: 'a', text: 'Aprendizaje supervisado' },
        { id: 'b', text: 'Aprendizaje no supervisado' },
        { id: 'c', text: 'Aprendizaje semisupervisado' },
        { id: 'd', text: 'Aprendizaje por refuerzo' },
      ],
      correctAnswer: 'b',
      explanation: 'Agrupar clientes por patrones de compra es clustering, un problema de aprendizaje no supervisado porque no tenemos etiquetas previas de los grupos.',
      conceptLinked: 'Aprendizaje no supervisado',
    },
    {
      id: '4.1-a2',
      type: 'multiple-choice',
