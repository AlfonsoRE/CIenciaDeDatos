  ...
  assessment: {
    ...
    questions: [
      ...
      },
      {
        id: '5.3-q3',
        type: 'multiple-choice',
        text: '¿Cuál de los siguientes es un reto ético mencionado en la lección sobre CD en salud?',
        options: [
          { id: 'a', text: 'El sesgo en datasets por subrepresentación de ciertos grupos' },
          { id: 'b', text: 'El bajo costo de los datos médicos' },
          { id: 'c', text: 'La ausencia total de regulación en cualquier país' },
          { id: 'd', text: 'El exceso de datos disponibles' },
        ],
        correctAnswer: 'a',
        explanation: 'La lección señala la privacidad, el sesgo por subrepresentación de grupos y la responsabilidad de decisiones automatizadas como retos éticos clave en salud.',
        conceptLinked: 'Retos éticos en salud',
        difficulty: 'medium',
      },
    ],
  },
