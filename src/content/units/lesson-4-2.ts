  ...
  assessment: {
    ...
    questions: [
      ...
      },
      {
        id: '4.2-q3',
        type: 'multiple-choice',
        text: '¿Cuál de los siguientes NO es un supuesto de la regresión lineal?',
        options: [
          { id: 'a', text: 'Linealidad de la relación' },
          { id: 'b', text: 'Independencia de los residuos' },
          { id: 'c', text: 'Homocedasticidad (varianza constante)' },
          { id: 'd', text: 'Que todas las variables sean categóricas' },
        ],
        correctAnswer: 'd',
        explanation: 'Los supuestos de la regresión lineal son linealidad, independencia y normalidad de residuos, y homocedasticidad; no requiere que las variables sean categóricas.',
        conceptLinked: 'Supuestos de la regresión',
        difficulty: 'medium',
      },
    ],
  },
