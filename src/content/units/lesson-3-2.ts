  ...
  assessment: {
    ...
    questions: [
      ...
      },
      {
        id: '3.2-q3',
        type: 'interpretation',
        text: 'Según la lección, ¿en qué consiste el error común de "leakage de escalado"?',
        options: [
          { id: 'a', text: 'Ajustar el escalador solo con datos de entrenamiento' },
          { id: 'b', text: 'Ajustar el escalador con datos de test, filtrando información al entrenamiento' },
          { id: 'c', text: 'No usar ningún escalador en el pipeline' },
          { id: 'd', text: 'Usar Min-Max en lugar de Z-score' },
        ],
        correctAnswer: 'b',
        explanation: 'El leakage ocurre al ajustar el escalador incluyendo datos de test; siempre se debe ajustar solo con train y luego transformar test con esos parámetros.',
        conceptLinked: 'Leakage de escalado',
        difficulty: 'medium',
      },
    ],
  },
