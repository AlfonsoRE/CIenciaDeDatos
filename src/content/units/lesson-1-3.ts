  ...
  assessment: {
    ...
    questions: [
      ...
      },
      {
        id: '1.3-q3',
        type: 'multiple-choice',
        text: '¿Qué tipo de dato es una respuesta de API en formato JSON?',
        options: [
          { id: 'a', text: 'Estructurado' },
          { id: 'b', text: 'Semiestructurado' },
          { id: 'c', text: 'No estructurado' },
        ...
        correctAnswer: 'b',
        explanation: 'JSON tiene etiquetas y jerarquía pero no es tabular, por lo que se clasifica como semiestructurado.',
        conceptLinked: 'Tipos de datos',
        difficulty: 'easy',
      },
    ],
